...
<div class="container mt-5">
    ...
    @method('PUT') 
        ...
        <div class="form-group">
                        ...
                        <input type="file" name="Foto" class="form-control-file" id="Foto" aria-describedby="Foto" value="{{ $Mahasiswa->foto }}">
                    </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="date" name="Tanggal_Lahir" class="form-control" id="Tanggal_Lahir" value="{{ $Mahasiswa->tanggal_lahir }}" aria-describedby="No_Handphone" > 
        </div>
